...
* - **Test non rileva alcun componente**
  ...
  - • Diminuire Accept Threshold (es: da 0.90 a 0.75)
...
* - Problema
  - Possibili Cause
  - Soluzioni
* - **Coordinate robot non disponibili (perse/dimenticate)**
  - • Non annotate durante preparazione fisica
    
    • Foglio appunti perso
    
    • Coordinate sovrascritte
  - • **OBBLIGATORIO**: Ripetere intera preparazione fisica dal punto 1-9 [Creazione Modello](Nuovo_Modello/18_NuovoModello.md)
...
* - **Gripper Offset calcola valori assurdi**
 ...
 - Copiare valori esattamente come annotati senza approssimazioni
