...
Il processo di creazione di una ricetta Mix è **identico** a quello di una ricetta Standard. Non è necessario selezionare alcuna opzione preliminare. Si può quindi seguire la procedura di [Creazione Ricette e Modelli - Panoramica](../QUICKSTART/Nuovo_Modello/16_NuovaRicetta.md)
